...
#define MAINPARAMS void* edc, int edx
...
namespace H
{
	...
	void	FASTCALL	hkDoExtraBonesProcessing(uintptr_t ecx, uintptr_t edx, CStudioHdr* hdr, Vector* pos, Quaternion* q, matrix3x4_t* matrix, c_bone_bit_list& bone_list, c_ik_context* context);
