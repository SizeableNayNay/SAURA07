...
// used: color highlights for cursor
#include "../../base/core/variables.h"
...
void ImGui::Render()
{
    ...
    if (g.IO.MouseDrawCursor)
		// modified by qo0
        RenderMouseCursor(&g.ForegroundDrawList, g.IO.MousePos, g.Style.MouseCursorScale, g.MouseCursor, IM_COL32(C::Get<Color>(Vars.colColorHighlights).r(), C::Get<Color>(Vars.colColorHighlights).g(), C::Get<Color>(Vars.colColorHighlights).b(), 255), IM_COL32_BLACK, IM_COL32(0, 0, 0, 48));
